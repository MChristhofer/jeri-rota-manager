(function(){
  ...
  function injectServiceEditor(){
    ...
    box.innerHTML=`<legend>2. Serviços da reserva</legend><div class="service-editor-head"><p>Adicione cada transfer ou passeio como um serviço independente.</p><button type="button" class="outline-button" id="addReservationService">+ Adicionar serviço</button></div><div id="reservationServiceDrafts"></div><div class="reservation-sale-total"><span>Total da reserva</span><strong id="reservationServicesSaleTotal">R$ 0,00</strong><small>Soma automática dos valores de venda.</small></div>`;
