(async function(){
  ...
  try{
    ...
    if(currentPage==='index.html'||currentPage===''){
      ...
      const loadCloudWriter=()=>{if(document.querySelector('script[src^="cloud-write-sync.js"]'))return;const script=document.createElement('script');script.src='cloud-write-sync.js?v=20260907-1';script.onload=loadCloudDelete;document.body.appendChild(script)};
      const loadUiPolish=()=>{
      ...
      const loadServicesManager=()=>{if(document.querySelector('script[src^="manager-services-section.js"]'))return;const script=document.createElement('script');script.src='manager-services-section.js?v=20260918-1';document.body.appendChild(script)};
      ...
      const initReservationModules=()=>{
        ...
        const loadCommitments=()=>{
          if(!document.querySelector('link[href^="finance-basic.css"]')){const link=document.createElement('link');link.rel='stylesheet';link.href='finance-basic.css?v=20260907-1';document.head.appendChild(link)}
        ...
        if(!document.querySelector('script[src^="reservation-flow.js"]')){const script=document.createElement('script');script.src='reservation-flow.js?v=20260923-3';script.onload=()=>{releaseCompatibilityRequired();loadEnhancements()};document.body.appendChild(script)}else{releaseCompatibilityRequired();loadEnhancements()}
      };
