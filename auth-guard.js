  ...
  try{
    ...
    if(currentPage==='index.html'||currentPage===''){
      ...
      const loadUiPolish=()=>{
        ...
        if(!document.querySelector('script[src^="reservation-draft-preserver.js"]')){const script=document.createElement('script');script.src='reservation-draft-preserver.js?v=20260831-1';document.body.appendChild(script)}
      };
      ...
      const initReservationModules=()=>{
        ...
        const loadCommitments=()=>{
          ...
          const script=document.createElement('script');script.src='finance-basic.js?v=20260831-6';script.onload=openRequestedReservation;script.onerror=()=>console.error('Falha ao carregar o módulo Compromissos.');document.body.appendChild(script)
        };
        const loadCatalog=()=>{if(document.querySelector('script[src^="reservation-service-catalog.js"]')){loadCommitments();return}const catalog=document.createElement('script');catalog.src='reservation-service-catalog.js?v=20260831-6';catalog.onload=loadCommitments;catalog.onerror=()=>{console.error('Falha ao carregar catálogo de serviços.');loadCommitments()};document.body.appendChild(catalog)};
        const loadLocationSuggestions=()=>{if(document.querySelector('script[src^="reservation-location-suggestions.js"]')){loadCatalog();return}const locations=document.createElement('script');locations.src='reservation-location-suggestions.js?v=20260831-6';locations.onload=loadCatalog;document.body.appendChild(locations)};
        ...
        if(!document.querySelector('script[src^="reservation-flow.js"]')){const script=document.createElement('script');script.src='reservation-flow.js?v=20260831-6';script.onload=()=>{releaseCompatibilityRequired();loadEnhancements()};document.body.appendChild(script)}else{releaseCompatibilityRequired();loadEnhancements()}
      };
