(async function(){
  ...
  try{
    ...
    if(currentPage==='index.html'||currentPage===''){
      ...
      const loadCompactUi=()=>{if(!document.querySelector('link[href^="reservation-compact-ui.css"]')){const link=document.createElement('link');link.rel='stylesheet';link.href='reservation-compact-ui.css?v=20260826-4';document.head.appendChild(link)}if(!document.querySelector('link[href^="reservation-repasse-message.css"]')){const link=document.createElement('link');link.rel='stylesheet';link.href='reservation-repasse-message.css?v=20260826-3';document.head.appendChild(link)}const loadRepasseMessage=()=>{if(document.querySelector('script[src^="reservation-repasse-message.js"]'))return;const repasse=document.createElement('script');repasse.src='reservation-repasse-message.js?v=20260826-1';document.body.appendChild(repasse)};if(document.querySelector('script[src^="reservation-compact-ui.js"]')){loadRepasseMessage();return}const script=document.createElement('script');script.src='reservation-compact-ui.js?v=20260825-1';script.onload=loadRepasseMessage;document.body.appendChild(script)};
      const loadUiPolish=()=>{
      ...
      const initReservationModules=()=>{
        ...
        const loadLocationSuggestions=()=>{if(document.querySelector('script[src^="reservation-location-suggestions.js"]')){loadCompactUi();openRequestedReservation();return}const locations=document.createElement('script');locations.src='reservation-location-suggestions.js?v=20260825-4';locations.onload=()=>{loadCompactUi();openRequestedReservation()};document.body.appendChild(locations)};
